...
public class RedisTest {
    ...
    public void testHashes() {
        ...
        redisTemplate.opsForHash().put(redisKey,"username","jean");
    ...
    public void testSets() {
        ...
        redisTemplate.opsForSet().add(redisKey,"jean","赵丽颖","杨幂","刘诗诗");
    ...
    public void testSortSets() {
        ...
        redisTemplate.opsForZSet().add(redisKey,"猪八戒",2);
        redisTemplate.opsForZSet().add(redisKey,"沙僧",3);
        redisTemplate.opsForZSet().add(redisKey,"孙悟空",4);
    ...
    public void testTransaction() {
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations redisOperations) throws DataAccessException {
                ...
                redisOperations.opsForSet().add(redisKey,"jeana");
                redisOperations.opsForSet().add(redisKey,"TheHighPriestess");
                redisOperations.opsForSet().add(redisKey,"chen");
